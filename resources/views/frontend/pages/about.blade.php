    ...
    <main>
        ...
        <section class="about-site section-padding">
            <div class="container">
                ...
                <!-- Section Title End -->
                <div class="about-img bg-image-center" style="background-image: url(assets/img/about/01.jpg);"></div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="mission-box">
                            <div class="mission-bg bg-img-center" style="background-image: url(assets/img/about/02.jpg);">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="mission-box">
                            <div class="mission-bg bg-img-center" style="background-image: url(assets/img/about/03.jpg);">
                            </div>
                            <div class="mission-desc">
                    ...
                    <div class="col-lg-4 col-md-6 mx-auto">
                        <div class="mission-box">
                            <div class="mission-bg bg-img-center" style="background-image: url(assets/img/about/04.jpg);">
                            </div>
                            <div class="mission-desc">
                                <h4>What We Do?</h4>
                                <p>Sedut perspiciatis unde omnis iste natu error
