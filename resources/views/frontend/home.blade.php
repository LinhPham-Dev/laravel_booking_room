                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="single-service-box text-center wow fadeIn animated" data-wow-duration="1500ms"
                            ...
                            <div class="service-icon">
                                <img src="{{ asset('assets/frontend') }}/img/icons/01.png" alt="Icon"
                                    class="first-icon">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="single-service-box text-center wow fadeIn animated" data-wow-duration="1500ms"
                            ...
                            <div class="service-icon">
                                <img src="{{ asset('assets/frontend') }}/img/icons/02.png" alt="Icon"
                                    class="first-icon">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="single-service-box text-center wow fadeIn animated" data-wow-duration="1500ms"
                            ...
                            <div class="service-icon">
                                <img src="{{ asset('assets/frontend') }}/img/icons/03.png" alt="Icon"
                                    class="first-icon">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="single-service-box text-center wow fadeIn animated" data-wow-duration="1500ms"
                            ...
                            <span class="service-counter">03</span>
                            <div class="service-icon">
                                <img src="{{ asset('assets/frontend') }}/img/icons/04.png" alt="Icon"
                                    class="first-icon">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="single-service-box text-center wow fadeIn animated" data-wow-duration="1500ms"
                            ...
                            <span class="service-counter">03</span>
                            <div class="service-icon">
                                <img src="{{ asset('assets/frontend') }}/img/icons/05.png" alt="Icon"
                                    class="first-icon">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="single-service-box text-center wow fadeIn animated" data-wow-duration="1500ms"
                            ...
                            <span class="service-counter">03</span>
                            <div class="service-icon">
                                <img src="{{ asset('assets/frontend') }}/img/icons/06.png" alt="Icon"
                                    class="first-icon">
