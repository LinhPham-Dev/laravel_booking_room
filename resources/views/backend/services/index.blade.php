            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="d-inline-block my-0" style="line-height: 35px">DataTable services</h5>
                        <div class="action float-end">
                            <a href="{{ route('services.create') }}" class="btn btn-outline-success mx-3"><i
                                    class="fas fa-plus m-1"></i>Add New</a>
                            <a href="{{ route('services.trash') }}" class="btn btn-outline-danger"><i
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="alert alert-warning alert-dismissible fade show p-3" role="alert">
                                    <span>No any services here !</span>
                                </div>
                                @else
                                {{-- Show All services --}}
                                <table class="table table-bordered table-hover text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img width="70px" src="{{ asset("uploads/services/$service->image") }}"
                                                    alt="{{ $service->title }}">
                                            </td>
                                            <td>
                                            ...
                                            <td width="15%">
                                                <a class="btn btn-info m-1"
                                                    href="{{ route('services.edit', $service->id) }}" role="button"><i
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-5">
                                        <div class="dataTables_info my-2">
                                            <p>Showing {{ $services->firstItem() }} to {{ $services->lastItem() }} of
                                                {{$services->total()}} entries</p>
                                        </div>
                                    </div>
